...
class HomeBanner(models.Model):
    img1 = models.ImageField(upload_to='home_banner/', blank=True, null=True)
    img2 = models.ImageField(upload_to='home_banner/', blank=True, null=True)
    img3 = models.ImageField(upload_to='home_banner/', blank=True, null=True)
    

    def __str__(self):
        return "Home Banner"
class HomeBanner2(models.Model):
    img = models.ImageField(upload_to='home_banner2/', blank=True, null=True)
